...
import { checkStatus, listTodos, createTodo, retrieveTodo, updateTodo, toggleTodo } from "./apiCalls";
...
function App() {
  ...
  const [renderPage, switchRenderPage] = useState(<ErrorPage error={"App Loading..."} />);
